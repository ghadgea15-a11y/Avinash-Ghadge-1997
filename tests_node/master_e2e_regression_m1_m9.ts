...
async function main() {
  ...
  await runTest('CROSS_MOD_1', 'HCM -> WFM -> BPM -> Payroll & Statutory Computation', async () => {
    ...
    // 2 half-days
    attendances.push(
      { id: 'ATT_2026_03_27', employeeId: 'EMP_001', companyId, siteId: 'SITE_MUMBAI_HQ', date: '2026-03-27', status: 'HALFDAY', createdAt: '2026-03-27T00:00:00Z', updatedAt: '2026-03-27T00:00:00Z' },
      { id: 'ATT_2026_03_28', employeeId: 'EMP_001', companyId, siteId: 'SITE_MUMBAI_HQ', date: '2026-03-28', status: 'HALFDAY', createdAt: '2026-03-28T00:00:00Z', updatedAt: '2026-03-28T00:00:00Z' }
    );
    ...
    // Assertions
    assert(calc.payableDays === 28.5, `Expected 28.5 payable days (31 - 2.5 LOP), got ${calc.payableDays}`);
    assert(calc.lopDays === 2.5, `Expected 2.5 LOP days (31 - 28.5), got ${calc.lopDays}`);
