const fs = require('fs');
let code = fs.readFileSync('src/components/screens/dashboards/DirectorDashboard.tsx', 'utf-8');
...
if (!code.includes('EnterpriseIntelligenceDashboard')) {
  ...
  fs.writeFileSync('src/components/screens/dashboards/DirectorDashboard.tsx', code);
}
