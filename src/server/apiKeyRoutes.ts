 ...
 */
apiKeyRoutes.post('/api-keys/generate', async (req: Request, res: Response) => {
  try {
 ...
 */
apiKeyRoutes.post('/api-keys/rotate', async (req: Request, res: Response) => {
  try {
 ...
 */
apiKeyRoutes.post('/api-keys/revoke', async (req: Request, res: Response) => {
  try {
 ...
 */
apiKeyRoutes.get('/api-keys', async (req: Request, res: Response) => {
  try {
 ...
 */
apiKeyRoutes.get('/v1/ping', requireApiKey('READ_ATTENDANCE'), (req: ApiKeyAuthenticatedRequest, res: Response) => {
  return res.json({
    status: 'ok',
