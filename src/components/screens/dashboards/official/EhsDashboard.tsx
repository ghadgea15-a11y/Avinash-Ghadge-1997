...
export const EhsDashboard: React.FC<DashboardProps> = ({ userSession, company, onNavigate }) => {
  ...
  if (loading) {
    return <div className="p-8 text-center text-slate-500">Loading EHS Metrics...</div>;
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-slate-500">Unresolved Safety Incidents</h3>
