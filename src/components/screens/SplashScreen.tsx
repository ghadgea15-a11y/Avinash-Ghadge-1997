...
export const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  return (
    <div className="flex-1 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 flex flex-col justify-between p-6 relative overflow-hidden select-none">
      ...
      <div className="flex flex-col items-center text-center pt-8 space-y-3">
        ...
        <span className="inline-block px-3 py-1 rounded-full bg-slate-900 border border-slate-800 text-[11px] font-mono text-indigo-300">
          Android Native Edition v1.0.0
        </span>
      </div>

      {/* Middle Section: Startup Diagnostics Queue */}
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 my-6 shadow-xl backdrop-blur-sm">
      ...
      <div className="text-center text-[10px] text-slate-500 font-mono space-y-1 pb-2">
        <p>Google Play Store Target SDK 34 • Material Design 3</p>
        <p className="text-slate-600">Built with Jetpack Compose & Firebase Multi-Tenant Architecture</p>
      </div>
    </div>
  );
};
