                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span className="px-2 py-0.5 rounded text-[11px] font-mono font-bold bg-amber-950/80 text-amber-400 border border-amber-800/80" title="Company ID / Code">
                          {companyCodeDisplay}
                        </span>
                      ...
                      {company.companyLegalName && company.companyLegalName !== company.brandName && (
                        <p className="text-xs text-slate-400 truncate max-w-[220px]" title={company.companyLegalName}>
                          {company.companyLegalName}
                        </p>
                      )}
                    </div>

                    <span className={`px-2.5 py-0.5 rounded text-[11px] font-bold uppercase shrink-0 ${
                  ...
                  <div className="text-xs space-y-1.5 bg-slate-950/50 p-2.5 rounded-xl border border-slate-800/50">
                    <div className="flex items-center justify-between">
                      <p className="text-[11px] text-slate-400 font-medium">Company Administrator</p>
                    ...
                    <div className="flex items-center justify-between gap-1 pt-0.5">
                      <p className="text-[11px] text-slate-400 font-mono truncate max-w-[170px]" title={company.adminEmail || company.email || ''}>
                      ...
                      {(company.adminEmail || company.email) && (
                        <button
                          ...
                          className="shrink-0 px-2 py-0.5 rounded text-[11px] font-semibold bg-amber-950/60 hover:bg-amber-900 text-amber-300 border border-amber-800/70 flex items-center gap-1 transition disabled:opacity-50"
                        >
