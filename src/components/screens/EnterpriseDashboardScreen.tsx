...
export const EnterpriseDashboardScreen: React.FC<EnterpriseDashboardScreenProps> = (props) => {
  ...
  if (props.userSession?.role === 'SUPER_ADMIN') {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-white dark:bg-slate-950 dark:bg-slate-900 flex-1">
        ...
        <h2 className="text-2xl font-bold text-black dark:text-white mb-2">Platform Access Violation</h2>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 w-full max-w-7xl mx-auto pb-24 lg:pb-8 animate-fade-in">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-black dark:text-white tracking-tight">Dashboard</h1>
