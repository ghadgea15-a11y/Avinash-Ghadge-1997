    ...
    <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 hover:border-slate-700 transition-all group relative overflow-hidden">
      ...
      <div className="flex items-start justify-between mb-4 relative z-10">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              <span className="text-[10px] font-mono text-slate-500 uppercase tracking-wider">{device.manufacturer}</span>
              <span className="w-1 h-1 rounded-full bg-slate-700"></span>
              <span className="text-[10px] font-mono text-slate-400">{device.ipAddress}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {lastAction && (
            <span className="text-[10px] font-medium text-amber-400 animate-fade-in bg-amber-500/10 px-2 py-1 rounded-lg border border-amber-500/20">
              {lastAction}
            </span>
          )}
      ...
      <div className="grid grid-cols-2 gap-3 mb-5 relative z-10">
        <div className="p-3 rounded-2xl bg-slate-950 border border-slate-800/50 space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium uppercase">Last Synced</span>
        ...
        <div className="p-3 rounded-2xl bg-slate-950 border border-slate-800/50 space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium uppercase">Total Punches</span>
      ...
      <div className="flex items-center justify-between gap-2 relative z-10">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-[11px] font-bold text-white transition-all border border-slate-700 hover:border-slate-600"
        >
