    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col lg:flex-row gap-4 items-end bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div className="flex-1">
          ...
          <p className="text-sm text-slate-500 mt-1">Authoritative, real-time data directly from core modules.</p>
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          <div>
            ...
            <input 
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          <div>
          ...
          <div className="flex items-end">
            <button 
              ...
              className="p-2 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 transition-colors"
              title="Reset Filters"
            >
      ...
      {loading ? (
        <div className="p-12 flex flex-col items-center justify-center bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800">
          ...
          <p className="text-slate-500 font-medium">Aggregating Authoritative Records...</p>
        </div>
      ) : error ? (
