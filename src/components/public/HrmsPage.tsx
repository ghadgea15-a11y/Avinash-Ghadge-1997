  ...
  return (
    <article className="space-y-16 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section aria-labelledby="hrms-hero-heading" className="text-center space-y-6 max-w-4xl mx-auto pt-6 pb-4">
        ...
        <h1 id="hrms-hero-heading" className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-black tracking-tight leading-tight">
      ...
      <section aria-labelledby="core-modules-heading" className="space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <h2 id="core-modules-heading" className="text-2xl sm:text-3xl font-display font-bold text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {coreModules.map((mod) => {
            ...
            return (
              <div 
                key={mod.title}
                className="bg-white dark:bg-slate-900 border border-slate-200 rounded-2xl p-6 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-6 group"
              >
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2 pt-2 border-t border-slate-100">
                    {mod.points.map((pt) => (
                      <li key={pt} className="flex items-center gap-2 text-xs text-slate-900 dark:text-slate-300">
      ...
      <section aria-labelledby="workflow-heading" className="bg-white dark:bg-slate-900 border border-slate-200 rounded-3xl p-8 sm:p-12 shadow-sm space-y-8">
        <div className="max-w-3xl space-y-3">
          ...
          <h2 id="workflow-heading" className="text-2xl sm:text-3xl font-display font-bold text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
          {[
            ...
            <div key={st.step} className="p-5 rounded-xl bg-white border border-slate-200 space-y-3">
              <div className="text-xs font-mono font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-md inline-block">
                STEP {st.step}
              </div>
              <h3 className="text-sm font-bold text-black">{st.title}</h3>
      ...
      <section aria-labelledby="faq-heading" className="space-y-6 max-w-4xl mx-auto">
        <div className="text-center space-y-2">
          <h2 id="faq-heading" className="text-2xl font-display font-bold text-black">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="p-5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 shadow-xs space-y-2">
      ...
      {/* CTA Footer Card */}
      <section className="bg-black text-white rounded-3xl p-8 sm:p-12 text-center space-y-6 shadow-xl">
