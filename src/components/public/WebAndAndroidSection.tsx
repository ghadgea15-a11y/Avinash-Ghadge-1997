...
export const WebAndAndroidSection: React.FC = () => {
  return (
    <section id="technology" className="py-24 lg:py-32 bg-white border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="p-8 sm:p-12 rounded-3xl border border-slate-200 bg-white dark:bg-slate-900 shadow-sm space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200 space-y-4 text-center">
              <div className="w-12 h-12 rounded-xl bg-black text-white mx-auto flex items-center justify-center">
            ...
            <div className="p-6 rounded-2xl bg-black text-white border border-[#27272A] space-y-4 text-center shadow-lg relative">
          ...
          <div className="pt-8 border-t border-slate-200 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 font-body text-xs">
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 font-display font-bold text-black">
                <RefreshCw className="w-4 h-4 text-emerald-600" />
                <span>Bi-Directional Sync</span>
              </div>
              <p className="text-black">Roster changes made in the web app reflect instantly on supervisor mobile devices.</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-black">Patrol and muster scans in basement areas sync automatically upon regaining cellular network.</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-black">Guards and supervisors can only query site data belonging to their assigned company ID.</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-black">Web and Android clients access the exact same data schema with zero duplication.</p>
            </div>
          </div>
