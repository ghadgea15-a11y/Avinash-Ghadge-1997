  ...
  return (
    <article className="space-y-16 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section aria-labelledby="leave-hero-heading" className="text-center space-y-6 max-w-4xl mx-auto pt-6 pb-4">
        ...
        <h1 id="leave-hero-heading" className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-[#0A0D14] tracking-tight leading-tight">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-2xl bg-white border border-[#E8E7E3] space-y-3 shadow-xs">
          ...
          <h3 className="text-base font-bold text-[#0A0D14]">Multi-Tier Approval Chains</h3>
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#E8E7E3] space-y-3 shadow-xs">
          ...
          <h3 className="text-base font-bold text-[#0A0D14]">Live Balance Ledgers</h3>
          <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#E8E7E3] space-y-3 shadow-xs">
          ...
          <h3 className="text-base font-bold text-[#0A0D14]">Auto Payroll LOP Deduction</h3>
          <p className="text-xs text-slate-600 leading-relaxed">
