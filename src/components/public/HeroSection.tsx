...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative pt-20 pb-24 lg:pt-32 lg:pb-32 overflow-hidden bg-[#FBFBFA]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#E2E0D8] bg-white/50 backdrop-blur-sm text-[11px] font-mono font-bold tracking-widest text-[#0A0D14] uppercase shadow-sm">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>Unified Operational Operating System</span>
          </div>

          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-[#0A0D14] leading-[1.1] tracking-tight">
            Run Every Site. <br />
            <span className="italic text-emerald-600 font-normal">Connect Every Operation.</span>
          </h1>

          <p className="font-body text-base sm:text-lg lg:text-xl text-[#52525B] max-w-2xl mx-auto font-medium leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#0A0D14] hover:bg-emerald-600 text-white text-sm font-bold font-body transition-colors duration-300 shadow-xl shadow-emerald-900/10 flex items-center justify-center gap-2 group"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-full border border-[#D4D4D8] hover:border-[#0A0D14] bg-white text-[#0A0D14] text-sm font-bold font-body transition-all duration-300 shadow-sm hover:shadow-md flex items-center justify-center gap-2"
            >
        ...
        >
          <div className="relative w-full h-[500px] sm:h-[650px] flex items-center justify-center transform-style-3d">
            ...
            <motion.div
              ...
              className="absolute z-10 w-[85%] max-w-[800px] aspect-[16/10] rounded-2xl bg-[#0A0D14]/90 backdrop-blur-2xl border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5),0_0_40px_rgba(16,185,129,0.2)] overflow-hidden flex flex-col"
            >
              {/* Fake Browser/App Header */}
              <div className="h-10 sm:h-12 border-b border-white/10 flex items-center px-4 justify-between bg-white/5">
              ...
              <div className="flex-1 p-4 sm:p-6 flex gap-4 sm:gap-6 bg-gradient-to-b from-transparent to-black/40">
                {/* Sidebar */}
                <div className="w-1/4 h-full rounded-xl border border-white/5 bg-white/5 p-3 flex flex-col gap-3">
                  <div className="w-full h-8 rounded-md bg-white/10 animate-pulse" />
                  <div className="w-3/4 h-4 rounded-md bg-white/5 mt-4" />
                ...
                <div className="flex-1 flex flex-col gap-4 sm:gap-6">
                  ...
                  <div className="flex gap-4 h-20 sm:h-24">
                    <div className="flex-1 rounded-xl border border-white/5 bg-white/5 p-4 flex flex-col justify-between">
                      <div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center">
                        <Users className="w-4 h-4 text-blue-400" />
                      </div>
                      <div className="w-16 h-6 rounded-md bg-white/20" />
                    </div>
                  ...
                  {/* Big Chart Area */}
                  <div className="flex-1 rounded-xl border border-white/5 bg-white/5 p-4 relative overflow-hidden">
            ...
            >
              ...
              <div className="flex-1 bg-[#0A0D14] p-4 pt-8 flex flex-col gap-4 relative">
                {/* Mobile Header */}
                ...
                {/* Mobile Content */}
                <div className="w-3/4 h-6 rounded-md bg-white/90 mt-2" />
                <div className="w-1/2 h-4 rounded-md bg-white/40" />
                
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <div className="aspect-square rounded-xl bg-white/10 border border-white/5" />
                ...
                <div className="absolute bottom-4 left-4 right-4 h-12 rounded-full bg-emerald-500 flex items-center justify-center">
                  <span className="font-bold text-black text-sm">Scan Now</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute z-30 top-[20%] left-[10%] px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 shadow-xl flex items-center gap-3"
            >
            ...
            <motion.div 
              ...
              className="absolute z-30 bottom-[30%] left-[5%] px-4 py-2 rounded-xl bg-[#0A0D14]/80 backdrop-blur-md border border-emerald-500/30 shadow-[0_0_20px_rgba(16,185,129,0.2)] flex items-center gap-3"
            >
